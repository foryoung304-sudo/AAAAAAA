...
void height_log_dump_task(void)
{
    ...
    if(height_log_dump_index == 0u)
    {
        ...
        printf("seq,time_us,tof_cm,height_cm,ekf_z_cm,ekf_vz_cm_s,acc_raw_cm_s2,acc_corrected_cm_s2,acc_lpf_cm_s2,acc_ekf_cm_s2,tof_diff_cm_s,innov_cm,throttle,target_vz_cm_s,tof_used,armed,final_height_cm,profile_height_cm,profile_vz_cm_s,position_correction_cm_s,profile_accel_cm_s2\r\n");
    }
    ...
    while((height_log_dump_index < height_log_count) && (lines < 4u))
    {
        ...
        printf("%u,%lu,%.1f,%.2f,%.2f,%.2f,%.1f,%.1f,%.1f,%.1f,%.2f,%.2f,%.2f,%.2f,%u,%u,%.2f,%.2f,%.2f,%.2f,%.1f\r\n",

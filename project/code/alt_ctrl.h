...
#define ALT_TAKEOFF_HEIGHT_CM            20.0f
#define ALT_TRANSITION_HEIGHT_CM         40.0f
...
#define ALT_POS_CORR_LIMIT_CM_S         10.0f
...
#define ALT_HOVER_TRIM_MAX               7.5f
#define ALT_HOVER_TRIM_SLEW              1.0f
#define ALT_NEAR_GROUND_BRAKE_HEIGHT_CM  23.0f
#define ALT_NEAR_GROUND_BRAKE_GAIN       0.0f
#define ALT_NEAR_GROUND_BRAKE_LIMIT      1.20f
#define ALT_VEL_FB_START_HEIGHT_CM       18.0f
#define ALT_VEL_FB_FULL_HEIGHT_CM        26.0f
...
#define ALT_TAKEOFF_BOOST_HEIGHT_CM      18.5f
...
#define ALT_TAKEOFF_VEL_LIMIT_HEIGHT_CM  23.0f
#define ALT_TAKEOFF_BOOST_MIN_ERR_CM     0.8f
#define ALT_TAKEOFF_COMPLETE_ERR_CM      0.4f
#define ALT_TAKEOFF_COMPLETE_HEIGHT_CM   20.0f

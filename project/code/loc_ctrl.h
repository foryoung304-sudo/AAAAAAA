...
// 控制限制参数 (保留)
#define MAX_HORIZONTAL_SPEED  125.0f    // 最大水平速度 (cm/s)
#define MAX_POS_CT_VAL         30.0f      // 最大位置控制输出 (即最大倾斜角度)
#define LOC_MAX_OUTPUT_ANGLE_DEG  15.0f
#define MAX_VEL_CT_VAL        50.0f
#define LOC_GRAVITY_CM_S2          980.665f
#define LOC_MAX_HORIZONTAL_ACCEL_CM_S2  250.0f

#define LOC_POS_CORRECTION_LIMIT_CM_S 15.0f
#define LOC_YAW_SPIN_POS_GAIN_SCALE     2.0f
#define LOC_YAW_SPIN_POS_CORRECTION_LIMIT_CM_S 22.0f
#define LOC_YAW_SPIN_TOTAL_VEL_LIMIT_CM_S      22.0f
...
#define LOC_TERMINAL_VEL_DAMPING_SCALE           2.20f

#define LOC_PROFILE_NEAR_SPEED_CM_S    5.0f
#define LOC_PROFILE_FAR_SPEED_CM_S   120.0f
#define LOC_PROFILE_BLEND_START_CM    20.0f
#define LOC_PROFILE_BLEND_END_CM      80.0f
#define LOC_TOTAL_VEL_LIMIT_CM_S     120.0f
...
#define LOC_TARGET_VEL_SLEW_CM_S2 110.0f
#define LOC_CAR_STOP_BRAKE_VEL_SLEW_CM_S2 200.0f

#define LOC_RECOVERY_BRAKE_MARGIN_CM_S      3.0f
#define LOC_RECOVERY_BRAKE_VEL_SLEW_CM_S2 120.0f
#define LOC_TRAJ_ACCEL_CM_S2      110.0f
...
#define LOC_ENABLE_HEIGHT_CM       30.0f
#define LOC_HOLD_ENABLE_HEIGHT_CM  30.0f
#define LOC_AUTO_LOW_ENABLE_HEIGHT_CM       8.0f
#define LOC_AUTO_TAKEOFF_HORIZONTAL_ENABLE_HEIGHT_CM 20.0f
#define LOC_AUTO_TAKEOFF_HORIZONTAL_RELEASE_HEIGHT_CM 17.0f
#define LOC_AUTO_LOW_HOLD_HEIGHT_CM        24.0f
#define LOC_AUTO_LOW_LANDING_HOLD_HEIGHT_CM 12.0f
#define LOC_AUTO_LOW_MAX_OUTPUT_ANGLE_DEG   5.0f
#define LOC_AUTO_TAKEOFF_INITIAL_MAX_OUTPUT_ANGLE_DEG 3.0f
#define LOC_AUTO_TAKEOFF_INITIAL_ANGLE_LIMIT_HEIGHT_CM 60.0f
...
#define LOC_HORIZONTAL_FAULT_MAX_ANGLE_DEG 5.0f
#define LOC_BLEND_TIME_S           0.5f
#define LOC_AUTO_LOW_BLEND_TIME_S  0.10f
